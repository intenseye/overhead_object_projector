...
def split_dataset(main_folder_path: str, validation_ratio: float, test_ratio: float,
    ...
    for dev_folder_path in dev_folder_paths:
        ...
        input_json_path = os.path.join(dev_folder_path, json_file_name)
        ...
        with open(input_json_path, 'r') as f:
            ...
            if already_set_indices is False:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_folder_path", help="Path to the json file including annotations.",
                        default=r"/home/poyraz/intenseye/input_outputs/overhead_object_projector/datasets/OverheadSimIntenseye/Set01")
